 ...
 * Microsoft JVM environment of Internet Explorer.<p>
 *
 * The MicrosoftStrategy uses the Microsoft-specific security framework to enable a
 ...
 */
public class MicrosoftStrategy extends Strategy
{
	/**
	 * Creates a new object to deal with obtaining permissions from the Microsoft-specific
	 * security environment.  Unlike the NetscapeStrategy, there is no need for a permission
	 * forecast by the constructor. The Microsoft security environment won't let an applet
	 * execute if the applet's cab indicates it needs permissions which the client has not
	 * enabled.
	 */
	public MicrosoftStrategy()
	{
		super();
	}
